...
@foreach ($posts as $post)
        ...
        <div class="col s12 m6">
          <div class="card hoverable z-depth-1">
            ...
            @endif
              <span class="card-title blue-text"><a href="{{ route('profile', ['user_id' => Auth::user()->id ]) }}">{{ ucfirst($post->user->firstname) }}&nbsp;{{ ucfirst($post->user->lastname) }}</a></span>
              <p>{{$post->post}}</p>
              <br>
...
@endforeach
  ...
  <div class="fixed-action-btn" style="bottom: 45px; right: 35px;">
    <a class="btn-floating btn-large red modal-trigger" href="#addpost">
  ...
  <!--<div class="fixed-action-btn" style="bottom: 45px; right: 100px;">
    <a class="btn-floating btn-large red modal-trigger" href="#addpost1">
